...
export function DevNoticeBar({
  ...
  return (
    <div
      ...
      className="flex items-center gap-2 border-b border-primary/30 bg-primary/10 px-4 py-2 text-xs text-primary dark:border-primary/20 dark:bg-primary/10 dark:text-primary"
    >
