...
/**
 * Read site.config.ts and extract the locales array.
 * @returns {string[]} The locales defined in site.config.ts
 */
function getSiteConfigLocales() {
  const siteJsonPath = path.resolve(MESSAGES_DIR, "../../config/site.json");
  if (fs.existsSync(siteJsonPath)) {
    try {
      ...
      console.warn(`WARNING: Could not parse site.json: ${err.message}`);
    }
  }
