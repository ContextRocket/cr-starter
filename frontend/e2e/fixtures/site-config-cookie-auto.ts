/**
 * E2E build-time override of `@/config/site.config` for the cookie-consent regression.
 *
 * WHY THIS EXISTS
 * ---------------
 ...
 *
 * NOTE: import the real config by RELATIVE path, never the aliased module --
 * otherwise the import would resolve back to this file and loop.
 */
...
import { siteConfig as realSiteConfig } from "../../config/site.config";
