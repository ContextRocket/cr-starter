/**
 * LocaleSwitcher render contract: the trigger is always visible, and the
 * dropdown menu exposes every supported locale (en/es/de) with a working
 * selection path. Structural assertions only - never literal copy.
 */
