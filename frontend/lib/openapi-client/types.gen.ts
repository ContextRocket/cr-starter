...
export type ConvertGuestErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type ConvertGuestError = ConvertGuestErrors[keyof ConvertGuestErrors];

export type ConvertGuestResponses = {
  /**
   * Successful Response
   */
  200: UserRead;
...
export type ConvertGuestResponse =
  ConvertGuestResponses[keyof ConvertGuestResponses];
