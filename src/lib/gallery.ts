 ...
 *   - `path` is relative to `public/` and is therefore portable to a
 ...
 *
 * This module has no filesystem imports. It can be used by server loaders,
 * client islands, validation scripts, and future CDN tooling.
 */
...
export interface GalleryVariant {
  /** Path relative to public/, just like GalleryAsset.path. */
  path: string;
...
export interface GalleryAsset {
  ...
  id: string;
  /** Path relative to `public/`, e.g. `gallery/profile/mark.jpg`. */
  path: string;
